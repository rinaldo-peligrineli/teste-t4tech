...
use App\Http\Controllers\Api\v1\Balldontlie\BalldontliePlayerController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
Route::group(['middleware' => ['auth:sanctum', 'personal.auth']], function () {
    ...
    Route::resource('balldontlies/players', BalldontliePlayerController::class, ['only' => ['index', 'show', 'store', 'update']]);

    Route::get('user/search', [UserController::class, 'search']);
    Route::get('balldontlies/team/search', [BalldontlieTeamsController::class, 'search']);
    Route::get('balldontlies/player/search', [BalldontliePlayerController::class, 'search']);

    Route::group(['middleware' => ['role:admin']], function () {
        Route::delete('users/delete/{id}', [UserController::class, 'delete']);
        Route::delete('balldontlies/teams/delete/{id}', [BalldontlieTeamsController::class, 'delete']);
        Route::delete('balldontlies/players/delete/{id}', [BalldontliePlayerController::class, 'delete']);
    });
});
