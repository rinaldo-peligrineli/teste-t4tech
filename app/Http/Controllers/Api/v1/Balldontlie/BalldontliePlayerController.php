...
class BalldontliePlayerController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $players = BalldontliePlayerResource::collection(
                $this->balldontliePlayerRepositoryInterface->getAllPlayersPaginate($perPage, $page)
            );
    ...
    {
        try {
            $player = new BalldontliePlayerResource(
                $this->balldontliePlayerRepositoryInterface->createPlayer($request->all())
            );
    ...
    public function search(Request $request): JsonResponse
    {
        try {
            ...
            $players = BalldontliePlayerResource::collection(
                $this->balldontliePlayerRepositoryInterface->searchByColumn($column, $value)
            );
